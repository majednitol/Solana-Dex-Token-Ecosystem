...
/// ========= Seeds (keep stable forever once deployed) =========
/// Important: if you change these after deploy, PDA addresses change.
...
/// ========= Defaults / limits =========
/// A safe cap to avoid huge compute / accidental overflows in tests.
/// Adjust if you truly need higher, but keep guardrails.
